...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe 'for signed-in users' do
      before(:each) do
        @user = Factory(:user)
        Factory(:user, :email => "user2@example.org")
        Factory(:user, :email => "user3@example.org")
        30.times do
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      before(:each) do
        @attr = {:name=>'New Name',:email=>'different@example.com',:password=>'barfoo',
          :password_confirmation=>'barfoo'}
      end

      it "should change the user's attributes" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user) # Grab @user from controller
        @user.reload
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      before(:each) do
        # Factory bypasses attr_accessible, so can set :admin
      ...
      it "should not allow deletion of admin user" do
        lambda do
  ...
  describe "follow pages" do
    ...
    describe "when not signed in" do
      ...
      it "should protected following" do
        get :following, :id => 1
        response.should redirect_to(signin_path)
      end

      it "should protected followers" do
        get :followers, :id => 1
        response.should redirect_to(signin_path)
      end
    end

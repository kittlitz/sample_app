...
describe User do
  ...
  it "Should reject duplicate email addresses" do
    User.create!(@attr)
    user_with_duplicate_email = User.new(@attr.merge(:name => "New"))
  ...
  describe 'password encryption' do
    ...
    describe 'has_passowrd? method' do
      it "should exist" do
      ...
      it "should return false if the passwords don't match" do
        @user.has_password?("bogus").should be_false
      end
      ...
      describe "authenticate method" do
        ...
        it "should return nil on email/password mismatch" do
          User.authenticate(@attr[:email],"wrong").should be nil
        end
  ...
  describe 'micropost associations' do
    ...
    before(:each) do
      @user = User.create(@attr)
      # Can set created_at if using FactoryGirl
    ...
    describe "status feed" do
      ...
      it "should include followed user's microposts" do
        ...
        mp3 = Factory(:micropost,:user => followed, :content => "yada");
  ...
  describe "relationships" do
    ...
    it "should included followed user in the following array" do
      @user.follow!(@followed)
